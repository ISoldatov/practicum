...
public class Practicum {
    ...
    private static void printOrderedByDateReceived(Set<Letter> letters) {
        ...
        Comparator<Letter> letterComparator = new Comparator<Letter>() {
            @Override
        ...
        Set<Letter> letterSet = new TreeSet<>(letterComparator);
        letterSet.addAll(letters);
        for (Letter l: letterSet) {
