...
public class SocNet_2 {
    ...
    static class PostsHandler implements HttpHandler {
        ...
        private Optional<Integer> getPostId(HttpExchange exchange) {
            ...
            String[] pathParameters = exchange.getRequestURI().getPath().split("/");
            if (pathParameters.length < 4 || pathParameters[2] == null) {
                return Optional.empty();
            }
            try {
                return Optional.of(Integer.valueOf(pathParameters[2]));
